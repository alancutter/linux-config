...
alias g="git"
alias gaarbc="git add -A && git rebase --continue"
alias gcb="google-chrome-beta"
alias gcbt="google-chrome-beta \"$TESTURL\""
alias gclu="git cl upload --no-find-copies"
...
alias tb="run-webkit-tests --fully-parallel --disable-breakpad --target release --num-retries=0 --time-out-ms=200000"
