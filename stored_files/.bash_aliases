...
alias blbt="bl bin/run_browser_tests"
alias blbtris="bl bin/run_lacros_chrome_browsertests_run_in_series"
alias blc="bl chrome"
alias blut="bl bin/run_unit_tests"
...
alias botlbt="botl bin/run_browser_tests"
alias botlbtris="botl bin/run_lacros_chrome_browsertests_run_in_series"
alias botlut="botl bin/run_unit_tests"
...
alias lbc="bcosc && blc"
alias lboc="lb && lo"
alias lbotbt="blbt && lotbt"
alias lbotut="blut && lotut"
alias lcl="cat /tmp/ash-chrome/lacros/lacros.log"
alias lcp="rm -rf /tmp/ash-chrome"
alias lhs="python3 -m http.server"
alias loc="XDG_RUNTIME_DIR=/tmp/ash_chrome_xdg_runtime /mnt/ssd/repos/chromium/src/out/chromeos/chrome --user-data-dir=/tmp/ash-chrome --enable-wayland-server --no-startup-window --enable-features=LacrosOnly,LacrosSupport --enable-ash-debug-browser --lacros-chrome-path=/mnt/ssd/repos/chromium/src/out/lacros --lacros-chrome-additional-args=--gpu-sandbox-start-early"
