...
alias tb="run-webkit-tests --disable-breakpad --debug --num-retries=0"
alias tbr="run-webkit-tests --disable-breakpad --release --num-retries=0"
alias tbrwt="run-webkit-tests --disable-breakpad --release --num-retries=0"
alias tbwt="run-webkit-tests --disable-breakpad --debug --num-retries=0"
