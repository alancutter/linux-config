...
alias spd="~/repos/chromium/src/third_party/WebKit/Tools/Scripts/webkitruby/PrettyPatch/prettify.rb > /tmp/pretty-diff && o /tmp/pretty-diff"
alias t="tree -L 2"
